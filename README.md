...
Developed the hours worked input module

Conducted payroll computation testing
...
Developed the employee information display module

Assisted in debugging and revising the code
...
Developed the gross salary calculation module

Assisted in preparing the final system output and submission
...
Developed the deductions computation module
...
Module-based coding and integration
...
Employees can view their personal profile information such as their ID number, name, birthday, and address.

Payroll staff have administrative access that allows them to process payroll reports. The system calculates employee working hours based on attendance logs and converts the recorded time-in and time-out values into total working hours. These hours are multiplied by the employee’s hourly rate to determine the gross salary for each payroll cutoff.
